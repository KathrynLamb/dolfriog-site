    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed top-0 w-full bg-white/95 backdrop-blur-sm shadow-sm z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4 sm:gap-6 min-w-0">
            <a href="/" className="text-2xl sm:text-3xl font-serif text-emerald-800 whitespace-nowrap">
              Dolfriog Hall
            </a>

            <nav className="flex items-center gap-3 sm:gap-4 text-xs sm:text-sm font-medium text-emerald-800">
          ...
          <a
            href="/booking"
            className="bg-emerald-700 hover:bg-emerald-800 text-white px-4 sm:px-6 py-2 rounded-md text-sm sm:text-base transition-colors whitespace-nowrap"
          >
            Book Your Stay
          </a>
        </div>
      ...
      <section id="hero" className="relative min-h-[100svh]">
        ...
        <div className="relative h-full flex items-center">
          <div className="max-w-7xl mx-auto px-6 w-full pt-24 sm:pt-24">
            <div className="ml-auto max-w-xl text-white text-right">
              ...
              <p className="text-base sm:text-xl text-white/90 mb-7 leading-relaxed">
                A rare Welsh retreat for people who want real peace: a historic hall for unforgettable gatherings,
                a secluded tiny house for two, and wild camping in woodland beside the river.
              </p>
      ...
      <section id="about" className="scroll-mt-28 py-16 sm:py-24 px-4 bg-stone-50">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-serif text-emerald-900 mb-6">Welcome to Dolfriog</h2>

              <p className="text-gray-700 text-lg leading-relaxed mb-6">
                Built in 1830 by George Holmes Jackson, Dolfriog Hall is a beautifully preserved piece of Welsh
                history. Our Grade II-listed Tudor-Gothic estate sits in the stunning Nanmor Valley, just outside
                the village of Beddgelert.
              </p>

              <p className="text-gray-700 text-lg leading-relaxed mb-6">
                Set within hundreds of acres of ancient Celtic rainforest beside a flowing river, we offer something
                rare: the feeling of stepping back in time while being completely immersed in nature.
              </p>

              <p className="text-gray-700 text-lg leading-relaxed">
                From its years as a school residential centre to the stories held within these walls, Dolfriog is a
                place with a living legacy — now welcoming guests to write the next chapter.
              </p>
      ...
      {/* ================= Accommodation ================= */}
      <section id="stays" className="scroll-mt-28 py-16 sm:py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl sm:text-4xl font-serif text-emerald-900 mb-4">Choose Your Experience</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  The main hall for big weekends: long dinners, fireside chats, and waking up to the valley. Ideal
                  for family gatherings, celebrations, or group retreats.
                </p>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  For real adventurers. Pitch up under ancient trees, breathe the clean mountain air, and reconnect
          ...
          <div className="mt-10 text-center">
            <p className="text-gray-600">
              ...
              <a
                href="/booking"
                className="text-emerald-800 font-medium underline underline-offset-4 hover:text-emerald-700"
              >
                Send an enquiry
              </a>{" "}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-96 rounded-lg overflow-hidden shadow-2xl">
              <img src="/snowdon.png" alt="Snowdonia landscape" className="w-full h-full object-cover" />
      ...
      <section className="relative py-20 px-4 bg-amber-50 border-y border-amber-100">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl sm:text-5xl font-serif text-emerald-950 mb-6">
            Help Us Save the Hall
          </h2>
          
          <p className="text-gray-700 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-8">
            Dolfriog Hall holds the childhood memories of thousands. We are undertaking a 
            massive restoration to save the roof, the rainforest, and the history.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a 
              href="/renovation" 
              className="inline-flex items-center justify-center bg-emerald-900 text-white hover:bg-emerald-800 px-8 py-4 rounded-md font-medium transition-all shadow-md hover:shadow-lg"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer" 
              className="inline-flex items-center justify-center text-emerald-900 border-2 border-emerald-900 hover:bg-emerald-100 px-8 py-4 rounded-md font-medium transition-colors"
            >
              Sponsor a Slate (£50)
            </a>
          </div>
          ...
          <p className="mt-6 text-sm text-gray-500 italic">
            "Join the Dolfriog Guild and help us keep the rain out."
          </p>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-serif text-emerald-900 mb-12 text-center">Adventures Await</h2>
      ...
      <section className="py-16 sm:py-24 px-4 bg-stone-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-serif text-emerald-900 mb-12">Guest Experiences</h2>

          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              <div className="text-amber-500 mb-4">★★★★★</div>
              <p className="text-gray-700 italic mb-4">
                "An absolutely magical place. The hall is stunning, full of character and history. Waking up to the
                sound of the river and views of the mountains was unforgettable."
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              <div className="text-amber-500 mb-4">★★★★★</div>
              <p className="text-gray-700 italic mb-4">
                "The tiny house was perfect for our romantic getaway. Complete privacy, beautifully designed, and
                the location in the forest is simply breathtaking. Can't wait to return."
              </p>
      ...
      {/* ================= Contact / Booking ================= */}
      <section id="book" className="scroll-mt-28 py-16 sm:py-24 px-4 bg-emerald-800 text-white">
        <div className="max-w-4xl mx-auto text-center">

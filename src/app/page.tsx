...
//           <h1 className="text-2xl sm:text-3xl font-serif text-emerald-800">Dolfriog Hall</h1>
//           <a href="#book" className="bg-emerald-700 hover:bg-emerald-800 text-white px-6 py-2 rounded-md text-sm sm:text-base transition-colors">
//             Book Your Stay
//           </a>
//         </div>
//       </header>
...
//     {/* Left stays clearer, right gets darker for text */}
...
//           Grade II Listed Victorian Estate · Snowdonia National Park
//         </p>

//         <h2 className="text-4xl sm:text-6xl lg:text-7xl font-serif leading-tight mb-6">
//           Stay Somewhere<br />
//           You’ll Never Forget
//         </h2>

//         <p className="text-lg sm:text-xl text-white/90 mb-8 leading-relaxed">
//           Escape to Dolfriog Hall — a historic Welsh manor set in ancient Celtic rainforest.
//           From grand group stays to secluded tiny house glamping and authentic wild camping,
//           discover a place where time slows and nature surrounds you.
//         </p>

//         <div className="flex flex-col sm:flex-row gap-4 justify-end">
//           <a
//             href="#stays"
//             className="inline-flex items-center justify-center bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 rounded-md text-lg font-medium transition-colors"
//           >
//             Explore Our Stays
//           </a>
//           <a
//             href="#book"
//             className="inline-flex items-center justify-center border-2 border-white/80 text-white hover:bg-white/10 px-8 py-4 rounded-md text-lg font-medium transition-colors"
//           >
//             Check Availability
//           </a>
//         </div>
...
//             <div>
//               <h3 className="text-3xl sm:text-4xl font-serif text-emerald-900 mb-6">
//                 Welcome to Dolfriog
//               </h3>
//               <p className="text-gray-700 text-lg leading-relaxed mb-6">
//                 Built in 1830 by George Holmes Jackson, Dolfriog Hall is a beautifully preserved piece of Welsh history. Our Grade II-listed Tudor-Gothic estate sits in the stunning Nanmor Valley, just outside the picturesque village of Beddgelert.
//               </p>
//               <p className="text-gray-700 text-lg leading-relaxed mb-6">
//                 Set within hundreds of acres of ancient Celtic rainforest beside a flowing river, we offer something truly special: a chance to step back in time while being surrounded by some of the most breathtaking natural beauty in Wales.
//               </p>
//               <p className="text-gray-700 text-lg leading-relaxed">
//                 From John Lennon's rumored childhood stay to serving as a beloved school residential centre, our walls hold countless stories. Now we're writing new chapters, welcoming guests to experience the magic of Snowdonia from this unique historic haven.
//               </p>
//             </div>
//             <div className="relative">
//               <img 
//                 src='/close_up.png'
//                 alt="Welsh stone house" 
//                 className="rounded-lg shadow-2xl"
//               />
//               <div className="absolute -bottom-6 -right-6 bg-emerald-800 text-white p-6 rounded-lg shadow-xl">
...
//             <h3 className="text-3xl sm:text-4xl font-serif text-emerald-900 mb-4">
//               Choose Your Experience
//             </h3>
//             <p className="text-gray-600 text-lg max-w-2xl mx-auto">
//               Whether you're looking for Victorian grandeur, cozy glamping, or wild adventure, we have the perfect stay for you
//             </p>
//           </div>
...
//                   <div>
//                     <h4 className="text-2xl font-serif text-emerald-900 mb-2">Dolfriog Hall</h4>
//                     <p className="text-gray-600 text-sm">Sleeps up to 20 guests</p>
//                   </div>
//                 </div>
//                 <p className="text-gray-700 mb-6 leading-relaxed">
//                   Experience authentic Victorian splendor in our fully restored manor house. Original Tudor-Gothic features, carved fireplaces, oak staircase, and stunning valley views. Perfect for family gatherings, celebrations, or group retreats.
//                 </p>
//                 <ul className="space-y-2 mb-6 text-sm text-gray-600">
//                   <li>✓ Original architectural features</li>
//                   <li>✓ Full modern kitchen & amenities</li>
//                   <li>✓ Exclusive estate access</li>
//                   <li>✓ Surrounded by ancient woodland</li>
//                 </ul>
//                 <a href="#book" className="block w-full text-center bg-emerald-700 hover:bg-emerald-800 text-white py-3 rounded-md transition-colors">
//                   Check Availability
//                 </a>
//               </div>
//             </div>

//             {/* Spindrift Tiny House */}
//             <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
//               <div className="relative h-64">
//                 <img 
//                   src="tiny_house.png0" 
//                   alt="Tiny house in forest" 
//                   className="w-full h-full object-cover"
//                 />
...
//                   <div>
//                     <h4 className="text-2xl font-serif text-emerald-900 mb-2">Spindrift Tiny House</h4>
//                     <p className="text-gray-600 text-sm">Sleeps 2 • Pet-friendly</p>
//                   </div>
//                 </div>
//                 <p className="text-gray-700 mb-6 leading-relaxed">
//                   Your private sanctuary deep in the Celtic rainforest. This beautifully crafted tiny house offers complete seclusion beside our river, with no other accommodation nearby. Wake to birdsong and fall asleep to the sound of flowing water.
//                 </p>
//                 <ul className="space-y-2 mb-6 text-sm text-gray-600">
//                   <li>✓ Total privacy & seclusion</li>
//                   <li>✓ Riverside location</li>
//                   <li>✓ Fully equipped kitchen</li>
//                   <li>✓ Dogs welcome</li>
//                 </ul>
//                 <a href="#book" className="block w-full text-center bg-amber-600 hover:bg-amber-700 text-white py-3 rounded-md transition-colors">
//                   Check Availability
//                 </a>
//               </div>
//             </div>
...
//                   <div>
//                     <h4 className="text-2xl font-serif text-emerald-900 mb-2">Wild Camping</h4>
//                     <p className="text-gray-600 text-sm">Pitch your tent</p>
//                   </div>
//                 </div>
//                 <p className="text-gray-700 mb-6 leading-relaxed">
//                   For true adventurers. Pitch your tent in pristine ancient woodland, surrounded by towering trees and the sounds of nature. Basic facilities with composting toilets and fresh mountain water. This is wild Wales at its most authentic.
//                 </p>
//                 <ul className="space-y-2 mb-6 text-sm text-gray-600">
//                   <li>✓ Authentic wild camping</li>
//                   <li>✓ Ancient forest setting</li>
//                   <li>✓ Basic eco-facilities</li>
//                   <li>✓ Complete immersion in nature</li>
//                 </ul>
//                 <a href="#book" className="block w-full text-center bg-green-700 hover:bg-green-800 text-white py-3 rounded-md transition-colors">
//                   Book Your Pitch
//                 </a>
//               </div>
//             </div>
...
//                 Located near the charming village of Beddgelert in Snowdonia National Park, Dolfriog offers unparalleled access to Wales' most spectacular landscapes. We're surrounded by ancient Celtic rainforest, with the majestic Snowdon massif rising to the north.
//               </p>
...
//                     <p className="text-emerald-200 text-sm">Picturesque village with shops, pubs & restaurants</p>
//                   </div>
//                 </div>
//                 <div className="flex items-start gap-3">
//                   <Trees className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-1" />
//                   <div>
//                     <p className="font-medium">Aberglaslyn Gorge</p>
//                     <p className="text-emerald-200 text-sm">Spectacular walking trails on your doorstep</p>
//                   </div>
//                 </div>
//                 <div className="flex items-start gap-3">
//                   <Heart className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-1" />
//                   <div>
//                     <p className="font-medium">Snowdon Access</p>
//                     <p className="text-emerald-200 text-sm">Multiple routes to Wales' highest peak nearby</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//         <div className="max-w-6xl mx-auto">
//           <h3 className="text-3xl sm:text-4xl font-serif text-emerald-900 mb-12 text-center">
//             Adventures Await
//           </h3>
//           <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
//             {[
//               { title: 'Mountain Hiking', desc: 'Direct access to Snowdon and countless trails', img: 'https://images.unsplash.com/photo-1551632811-561732d1e306?w=600&q=80' },
//               { title: 'Forest Walks', desc: 'Explore ancient Celtic rainforest paths', img: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=600&q=80' },
//               { title: 'Wild Swimming', desc: 'Crystal clear rivers and mountain lakes', img: 'https://images.unsplash.com/photo-1519046904884-53103b34b206?w=600&q=80' },
//               { title: 'Historic Villages', desc: 'Beddgelert, Portmeirion & Welsh Highland Railway', img: 'https://images.unsplash.com/photo-1467245581793-19089a60b2c2?w=600&q=80' },
//               { title: 'Wildlife Watching', desc: 'Rare species in protected habitat', img: 'https://images.unsplash.com/photo-1535083783855-76ae62b2914e?w=600&q=80' },
//               { title: 'Stargazing', desc: 'Incredible dark skies away from light pollution', img: 'https://images.unsplash.com/photo-1419242902214-272b3f66ee7a?w=600&q=80' }
//             ].map((activity, i) => (
...
//                   <h4 className="absolute bottom-4 left-4 text-white font-serif text-xl">{activity.title}</h4>
//                 </div>
...
//           <h3 className="text-3xl sm:text-4xl font-serif text-emerald-900 mb-12">
//             Guest Experiences
//           </h3>
...
//                 "An absolutely magical place. The hall is stunning, full of character and history. Waking up to the sound of the river and views of the mountains was unforgettable."
//               </p>
...
//               <div className="text-amber-500 mb-4">★★★★★</div>
//               <p className="text-gray-700 italic mb-4">
//                 "The tiny house was perfect for our romantic getaway. Complete privacy, beautifully designed, and the location in the forest is simply breathtaking. Can't wait to return."
//               </p>
...
//             Ready to experience the magic of Dolfriog? Get in touch to check availability and book your Welsh adventure.
//           </p>
...
//             </div>
//             <div className="bg-emerald-900/50 p-6 rounded-lg">
//               <Calendar className="w-8 h-8 text-emerald-300 mx-auto mb-3" />
//               <p className="text-sm text-emerald-200 mb-2">Book Online</p>
//               <p className="font-medium">Coming Soon</p>
//             </div>
//           </div>

//           <div className="bg-emerald-900/50 p-8 rounded-lg text-left max-w-2xl mx-auto">
//             <h4 className="text-xl font-serif mb-4">Find Us</h4>

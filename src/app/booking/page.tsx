...
// // import { Calendar, Users, Home, Trees, MapPin, Check, X, Mail, Phone, ChevronLeft, ChevronRight } from 'lucide-react';
...
// //   const [selectingDate, setSelectingDate] = useState('checkIn');
...
// //       features: ['Full estate access', 'Original Victorian features', 'Modern kitchen', 'Multiple bedrooms', 'Perfect for groups'],
// //       color: 'emerald'
// //     },
// //     {
// //       id: 'tiny',
...
// //       features: ['Complete privacy', 'Riverside location', 'Pet-friendly', 'Kitchen included', 'Romantic retreat'],
// //       color: 'amber'
// //     },
// //     {
// //       id: 'camping',
...
// //       price: 'From £25/night',
// //       image: '/glamping.png',
// //       features: ['Ancient forest setting', 'Composting toilets', 'Fresh mountain water', 'Basic facilities', 'True wild experience'],
// //       color: 'green'
// //     }
// //   ];
...
// //       const date = formatDate(currentMonth.year, currentMonth.month, day);
...
// //           <button onClick={prevMonth} className="p-2 hover:bg-stone-100 rounded-lg">
// //             <ChevronLeft className="w-5 h-5" />
// //           </button>
// //           <h3 className="font-semibold text-lg">
// //             {monthNames[currentMonth.month]} {currentMonth.year}
// //           </h3>
// //           <button onClick={nextMonth} className="p-2 hover:bg-stone-100 rounded-lg">
...
// //       return;
// //     }
// //     alert('Booking enquiry submitted! We\'ll be in touch within 24 hours to confirm your reservation.');
// //   };
...
// //             </div>
// //             <div className={`w-12 h-0.5 ${step >= 2 ? 'bg-emerald-700' : 'bg-gray-300'}`}></div>
...
// //             </div>
// //             <div className={`w-12 h-0.5 ${step >= 3 ? 'bg-emerald-700' : 'bg-gray-300'}`}></div>
...
// //                       property.color === 'emerald' ? 'bg-emerald-600' : 
// //                       property.color === 'amber' ? 'bg-amber-600' : 'bg-green-600'
...
// //                     <p className="text-2xl font-bold text-emerald-700 mb-4">{property.price}</p>
...
// //                       property.color === 'emerald' ? 'bg-emerald-700 hover:bg-emerald-800' : 
// //                       property.color === 'amber' ? 'bg-amber-600 hover:bg-amber-700' : 'bg-green-700 hover:bg-green-800'
...
// //                   <p className="text-emerald-700 font-semibold">{selectedProperty.price}</p>
// //                 </div>
// //               </div>
...
// //               <p className="text-gray-600 text-lg">Enter your details and we'll confirm your booking</p>
// //             </div>

// //             <div className="bg-white rounded-xl shadow-lg p-8">
// //               {/* Booking Summary */}
// //               <div className="bg-stone-50 rounded-lg p-6 mb-8">
// //                 <h3 className="font-serif text-xl text-emerald-900 mb-4">Your Booking Summary</h3>
...
// //                     <span className="text-emerald-700 font-bold">{selectedProperty.price}</span>
// //                   </div>
// //                 </div>
// //               </div>
...
// //                   <strong>Note:</strong> This is an enquiry form. We'll review your request and send you a confirmation email with payment details and booking confirmation within 24 hours.
// //                 </div>
